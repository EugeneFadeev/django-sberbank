    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(0, 'CREATED'), (1, 'PENDING'), (2, 'SUCCEEDED'), (3, 'FAILED'), (4, 'REFUNDED')], db_index=True, default=
                sberbank.models.Status['CREATED'], verbose_name='status')),
                ...
                ('method', models.PositiveSmallIntegerField(choices=[(0, 'UNKNOWN'), (1, 'WEB'), (2, 'APPLE'), (3, 'GOOGLE')], db_index=True, default=
                sberbank.models.Method['UNKNOWN'], verbose_name='method')),
                ('created', models.DateTimeField(auto_now_add=True, db_index=True, verbose_name='created')),
